    ...
    <AnimatePresence>
      {product && visible && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 z-[70] w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 cursor-pointer overflow-hidden rounded-2xl border border-gold/20 bg-[#161413] shadow-[0_20px_50px_rgba(0,0,0,0.7)] backdrop-blur-2xl"
        >
          ...
          <div className="h-0.5 w-full bg-white/[0.04]">
            <div className="animate-toast-countdown h-full rounded-full bg-gradient-to-l from-gold to-bronze" />
          </div>
        </motion.div>
      )}
    </AnimatePresence>
