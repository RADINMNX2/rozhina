...
export const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 left-5 z-40 flex items-center rounded-full border border-white/10 bg-[#25D366] p-3.5 text-white shadow-[0_12px_30px_-8px_rgba(37,211,102,0.45)] transition-[transform,box-shadow] duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_-8px_rgba(37,211,102,0.55)] active:scale-95"
    >
      ...
      <span className="pointer-events-none absolute left-full top-1/2 ml-2 origin-left -translate-y-1/2 scale-x-0 whitespace-nowrap rounded-full bg-[#25D366] px-4 py-2 text-sm font-bold opacity-0 shadow-[0_12px_30px_-8px_rgba(37,211,102,0.45)] transition-[transform,opacity] duration-300 group-hover:scale-x-100 group-hover:opacity-100">
